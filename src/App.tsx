        ...
        <div className="max-w-3xl">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-5">
              ...
              <a href="https://line.me/R/ti/p/@770bkxai" target="_blank" rel="noreferrer" className="bg-accent text-white px-10 py-5 rounded-2xl text-lg font-bold hover:opacity-90 transition-all flex items-center justify-center gap-3 shadow-2xl shadow-accent/20">
